...
| E-ea541c | entitas | "Ketua Dewan" (4×, bab 191, 193, 195, 199) muncul berulang tapi tidak ada di world-state maupun bible — entitas baru yang belum di-track? | frasa 'kursi Ketua Dewan' = jabatan historis kursi Aula Gema yg dikembalikan faksi (bab 191/193/195/199) — merujuk kursi dewan lama, bukan entitas karakter; kursi sudah dikembalikan bab 197 |
| E-b531b5 | entitas | "Nak" (2×, bab 79, 241) muncul berulang tapi tidak ada di world-state maupun bible — entitas baru yang belum di-track? | Sapaan 'Nak' (Tovin ke Renn bab 241, dan bab 79) — bukan entitas baru, hanya istilah panggilan ayah-ke-anak; sudah konsisten dengan relasi Tovin-Renn di world-state |
