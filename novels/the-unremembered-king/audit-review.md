...
| E-e60545 | entitas | "Nak" (25×, bab 44–239) ada di bible (kanon) tapi tidak tercatat di world-state — tambahkan ke tabel Tokoh? | False positive berulang: "Nak" = vokatif Indonesia (anak), bukan tokoh; muncul ulang di bab 230-239. |
...
| E-9c0da6 | entitas | … dan 19 kandidat lain — periksa dulu yang di atas sebelum melanjutkan | 19 kandidat sisa = pola sama dengan yang sudah ditinjau di tabel ini (vokatif Nak/Kak/Kakak/Paman, gelar+nama, variasi institusi, kepemilikan -nya/-mu); tidak ada entitas baru. |
