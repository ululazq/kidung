# Outline: Kidung Tanah Karam

Target: 24 bab @ 1.500–2.500 kata

## Premis

Sekar Ratri ingin keluar dari kampung yang tenggelam dan menyanyikan lagunya sendiri di Neo-Batavia, tapi warisan neneknya mengikatnya sebagai Juru Kidung dengan hanya dua belas tembang yang masing-masing bisa dipakai sekali seumur hidup — dan kalau dia salah membelanjakannya, seorang dalang yang kehilangan segalanya akan menyanyikan tanah karam itu naik beserta semua isinya.

## Struktur

| Titik | Bab | Isi |
|---|---|---|
| Kejadian pemicu | 1 | Sekar membelanjakan kidung pertamanya untuk membuat neneknya mati kering; mewarisi Serat dan hitungan |
| Akhir Babak I | 6 | Ki Danu menawarkan ibunya kembali; Sekar memutuskan tinggal untuk menghalanginya |
| Titik tengah | 12 | Kidung yang habis ternyata tidak musnah — dikumpulkan Kutha Teleng. Penjaga jadi pengumpan |
| Titik terendah | 18 | Wulansih menyanyikan kidung yang masih dipegang Sekar. Menimbun pun kalah |
| Klimaks | 21–23 | Sekar menyanyi salah laras; koleksi tersedak; Ki Danu memilih turun |
| Resolusi | 24 | Kidung buatan sendiri, tidak sempurna, harus diulang tiap tahun |
...
| Lie utuh | 1–4 |
| Retak pertama | 5 |
| Melihat kebenaran, belum sanggup | 12 |
| Lie merenggut sesuatu | 18 |
| Bertindak dari Need | 22–23 |
...
| 9 | Membubarkan tenda Lupa Corp — kampung harus tetap ingat supaya bisa diangkat. **Tercapai, dengan satu kerugian**: berkas dan gulungan tiket habis, tapi Marno berhenti bekerja untuknya sesudah menyerahkan kabar terakhir — bahwa Tegar memegang Lampor Wengi. **14 mulut jadi 13, dan dia sekarang tahu ada mulut ke-15 di luar hitungannya** |
| 13 | Mengumpulkan cukup mulut: tujuh belas orang yang mau menyanyi berbarengan |
| 17 | Mengambil Serat dari Langgar Kandas |
| 21 | Mulai menyanyikan Kidung Pamungkas di Segara Sepi saat Tanggul Lompong jebol |
| 23 | Kalau tidak dihalangi: Kutha Teleng naik, dan yang berdiri di jalanannya bukan orang |

## Subplot

| Subplot | Kenalan (bab) | Sentuhan (bab) | Resolusi (bab) |
|---|---|---|---|
| Tegar ingin dibawa keluar | 1 | 4, 7 ✓, 8 ✓, 9 ✓, 10, 14 | 24 |
| Ayu Prameswari merekam yang mematikan | 2 | 8 ✓, 9 ✓, 11 | 20 |
| Bu Rukmi tahu asal-usul Sekar | 2 | 10, 13 | 16 |
| Marno mencari kuburan Sapari | 3 | 9 ✓, 17 | 19 |
...
| 14 | Sekar | 2 (GCD, RDD) | Tegar memberi batas waktu satu malam → sekutu jadi harga yang harus dipilih | |
| 15 | Sekar | 2 (GCD, GCD) | Sekar menyelam dan melihat arsip Kutha Teleng nyaris lengkap → curiga jadi tahu tenggatnya | |
| 16 | Sekar | 2 (GCD, RDD) | Bu Rukmi mengaku Sekar bukan darah Larasati → pewaris jadi orang asing yang kebetulan diajari | |
| 17 | Sekar | 2 (GCD, GCD) | Ki Danu mengambil Serat dengan bantuan Marno → delapan jadi tujuh, dan naskah jadi hilang | |
| 18 | Sekar | 2 (GCD, RDD) | Wulansih menyanyikan Kidung Iber Toya yang masih di mulut Sekar → menimbun jadi terbukti kalah | |
| 19 | Sekar | 2 (RDD, GCD) | Marno membakar tiketnya dan menyebut tanggal pasang → tanpa arah jadi punya tenggat | |
| 20 | Sekar | 2 (GCD, GCD) | Ayu memutar take Sekar yang salah laras dan pitanya kosong → cacat suara jadi senjata | |
| 21 | Sekar | 2 (GCD, GCD) | Tanggul Lompong jebol, Ki Danu mulai menyanyi → tenggat jadi sekarang | |
| 22 | Sekar | 2 (GCD, GCD) | Sekar menyanyi enam kidung sekaligus, semuanya salah laras → tujuh jadi satu, dan koleksi tersedak | |
| 23 | Sekar | 2 (GCD, RDD) | Sekar membuat kidung baru dari halaman *gawe*; Ki Danu memilih turun sendiri → penghabis jadi pembuat | |
| 24 | Sekar | 2 (RDD, GCD) | Wulansih ditidurkan dengan kidung cacat yang harus diulang tiap tahun → selesai jadi harus dirawat | |
...
- Jeda empat hari antara rekaman dan lepasnya kidung ditegakkan sejak bab 8 dan dijelaskan di bab 12. Jangan menyelesaikannya lebih awal.
