...
> punya bab pendukung — lihat bagian Kanon yang dibatalkan di bawah.
...
| Nama baku | Catatan |
|---|---|
| Kota Tua Jakarta | latar payung seluruh novel |
| Museum Fatahillah | menara berjam raksasa; ruang arsip kuno di dalamnya (bab 2) |
| Pelabuhan Sunda Kelapa | arena utama. Juga disebut `Pelabuhan Tua` |
| simpang lima Kota Tua | titik pancer bumi. Klimaks bab 10–12 |
| Pintu Misteri Segara | gerbang kayu jati berukir naga laut, di ruang berpilar delapan di lorong bawah tanah Batavia |
| Alam Kelam / Samudera Gaib | dunia di balik gerbang. Singgasana Laut Selatan ada di dalamnya |
| Sungai Ciliwung | penanda fajar, bab 12 |
| Padepokan Bayang Jagad | lokasi baru untuk melatih generasi penerus. Diperkenalkan bab 13 |
| Ancol | bukit buatan, titik pengamatan gerhana (bab 6) |

### Faksi
| Nama baku | Tujuan | Cara mengenali |
|---|---|---|
| Dewan Tujuh Pusaka | menjaga pusaka dan batas dua dunia | nyaris habis; Pak Raden anggota terakhir yang diketahui |
| Pasukan Jiwa Kelam | menuruti Ki Demang | benang hitam kebal peluru, mata hijau fosfor, senjata karat abad ke-17 |
| Kerajaan Gaib Pantai Utara | mengincar Keris Kyai Sengkelat | utusannya terlihat di Cirebon (bab 13). **Belum pernah tampil** |

### Pusaka & istilah
| Nama baku | Apa itu |
|---|---|
| Keris Kyai Sengkelat | pusaka Arya. Cahaya emas; berubah warna mengikuti jiwa pemegangnya |
| Pedang Resonansi Suci | wujud transformasi Keris saat Arya mencapai keseimbangan (bab 8) |
| Selendang Mayang Pusaka | senjata Nyi Sembrani. Bisa memanjang, membentuk barikade angin dan lingkaran api |
| Pedang Bayang Segara | pusaka rahasia Ki Demang, disembunyikan di jantungnya. Terurai bab 9 |
| Kitab Catatan Jagad Batavia | kitab kulit kerbau milik Pak Raden. Mengkristal jadi batu abadi bab 11 |
| Panji Hitam | bendera rajah iblis; sumber kebangkitan Pasukan Jiwa Kelam |
| Perahu Naga Perak | perahu kertas yang dibesarkan mantra Nyi Sembrani |
| Gerhana Segara | gerhana bulan tepi merah darah; membuka Pintu Misteri Segara |
| Sembilan Kerayangan | sembilan punden berundak gaib di sembilan sudut Batavia, mengunci energi bumi dan menyerap jiwa penduduk |
| Ajian Sirep Pemutih Ingatan | mantra penghapus ingatan. Serbuk perak + tembang Jawa kuno |
| Ajian Gelap Ngampar | ajian penahan racun tingkat tinggi. Arya belum menguasainya (bab 4) |
...
- **Wound**: keluarganya dibantai belasan tahun lalu; ia menyalahkan dirinya atas kematian ayahnya. Gurunya, Kyai Ageng Wiraguna, gugur sebelum cerita dimulai.
- **Lie**: "Kegelapan di dalam darahku harus dimusnahkan, dan kekuatan didapat dengan mengerahkan amarah."
- **Want**: memutus kutukan darah dan mengalahkan Ki Demang Brata.
- **Need**: memaafkan dirinya, dan menerima kegelapannya sebagai bagian masa lalu alih-alih memeranginya.
- **Suara**: lugas, formal, sedikit kaku. Menyatakan niat dengan kalimat penuh. Bersumpah pada tanah dan rakyat, bukan pada dirinya.
- **Arc**: memusnahkan → menerima. Dibuktikan dua kali: bab 2 (bayangannya larut damai) dan bab 8 (cahaya berubah dari emas/merah jadi putih perak).

## Antagonis — Ki Demang Brata

- **Wound**: dihukum sebagai pengkhianat Mataram; namanya dihapus dari sejarah.
- **Lie**: "Keabadian sepadan dengan harga apa pun, dan kebaikan hanyalah kepura-puraan orang lemah."
- **Want**: membangkitkan Sang Penguasa Ombak dan menguasai dua dunia.
- **Need**: mengakui bahwa yang ia kejar bukan kekuasaan, tapi penghapusan rasa hina.
- **Pembelaan dirinya** (bab 8): Arya dan dia sama-sama sekadar wadah yang dipilih takdir. Bedanya ia jujur menerima kegelapan, sementara Arya berpura-pura jadi pahlawan dengan kebaikan palsu.
- **Jadwal** (andai Arya tidak menghalangi): buka Pintu Misteri Segara di puncak Bulan Merah → kerahkan Pasukan Jiwa Kelam meratakan pemukiman → racuni muara Ciliwung dengan Darah Segara → panen jeritan arwah leluhur sebagai bahan bakar → bangkitkan Sang Penguasa Ombak dari Singgasana Laut Selatan.

## Tokoh pendukung

| Nama | Tujuan sendiri | Penanda suara | Ciri fisik/kebiasaan |
|---|---|---|---|
| Nyi Sembrani | menjaga batas dua dunia dan menyiapkan penerus | memanggil "Arya"; menjelaskan aturan gaib lalu menakar risikonya | rambut perak, tongkat kayu, tas kain, selendang merah; menghela napas panjang sebelum kabar buruk |
| Pak Raden Suprapto | menutup tugas Dewan Tujuh Pusaka dengan benar | memanggil "Anak Muda"; tenang, pasrah | janggut putih, jubah arsiparis, kitab kulit kerbau |
| Kyai Ageng Wiraguna | — (sudah gugur) | aforisme panjang tentang pengendalian diri, dicetak miring | hadir sebagai cahaya atau suara batin |

## Relasi

| Pasangan | Saling menginginkan apa | Menyembunyikan apa | Siapa yang berkuasa |
|---|---|---|---|
| Arya–Nyi Sembrani | Arya: izin untuk gagal. Nyi: bukti Arya siap | Nyi: ritual-ritualnya memakan umurnya | Nyi Sembrani sampai bab 7; Arya sejak bab 8 |
| Arya–Ki Demang | pengakuan bahwa keduanya wadah yang sama | keduanya takut jadi tidak berarti | Ki Demang sampai bab 8 |
| Arya–Kyai Ageng Wiraguna | maaf yang tidak sempat diucapkan | Arya: ia merasa penyebab kematian gurunya | sang guru, lewat ajarannya |
| Arya–Ki Ageng Bayang | Ki Ageng: tubuh Arya | Arya: ia takut kegelapan itu memang dirinya | Ki Ageng sampai bab 2 |

## Sistem Kekuatan: Kanuragan & Resonansi Pusaka

- **Bisa**: menyalurkan energi kanuragan untuk melompat tinggi, berlari secepat kilat, melepaskan tebasan gelombang cahaya; membentuk zirah cahaya dari aura pusaka; menyembuhkan luka bakar dengan telapak tangan (Nyi Sembrani); membesarkan benda dengan mantra; menghapus ingatan manusia biasa.
- **Harga**: bukan tubuh, tapi **kejernihan jiwa**. Bertarung dengan amarah mencemari pusaka dan meredupkannya. Mantra tingkat tinggi memakan umur pemakainya. Mantra pengorbanan jiwa menukar nyawa penuh.
- **Siapa yang bisa memakai**: pewaris darah luhur (Arya), pendekar terlatih (Nyi Sembrani), anggota Dewan Tujuh Pusaka. Manusia biasa hanya bisa jadi saksi — dan ingatannya dihapus.
- **Tidak bisa**:
  - melukai wujud bayangan sendiri tanpa luka yang sama muncul di tubuh sendiri (bab 2)
  - masuk air yang tercemar Darah Segara tanpa Ajian Gelap Ngampar — Arya menembusnya di bab 4 hanya dengan zirah cahaya, dan tetap terbakar
  - menahan energi sembilan punden dengan satu pancer bumi saja (bab 10 → 11)
  - membangkitkan yang sudah gugur
- **Resonansi Pusaka Tingkat Tinggi**: dua pusaka setingkat dalam satu arena menimbulkan getaran yang memecahkan kaca radius lima kilometer dan meruntuhkan bangunan. Bisa dihentikan dengan menyelaraskan frekuensi, bukan dengan mengalahkan (bab 9).
- **Sudah didemonstrasikan**: bab 2 (luka balik), bab 3 (tebasan gelombang), bab 4 (zirah cahaya + harga), bab 5 (pemutihan ingatan), bab 7 (pencemaran amarah), bab 8 (transformasi keseimbangan), bab 9 (resonansi), bab 11 (pengorbanan jiwa).
...
README lama memuat nama-nama ini. **Tidak satu pun muncul di 14 bab yang ada.** Jangan dipakai kecuali kamu memang menulis ulang novel ini dari nol.

| Nama lama | Perannya di README lama | Padanan di kanon berlaku |
|---|---|---|
| Arya Pratama, arsiparis Museum Nasional | protagonis | `Arya`, pewaris keris. Arsiparisnya adalah **Pak Raden Suprapto** |
| Sita, Garda Bayang Nusantara | pendamping | Nyi Sembrani |
| Raden Mas Surowijo | antagonis, sorcerer era VOC | Ki Demang Brata, senopati Mataram |
| Gamelan Resonansi Tununggu | artefak utama | Keris Kyai Sengkelat |
| Garda Bayang Nusantara | faksi pelindung | Dewan Tujuh Pusaka |
| Penguasa Laut Selatan | entitas puncak | Sang Penguasa Ombak |
| Sembilan Kerayangan = sindikat okultis | faksi | **arti bergeser**: sembilan punden gaib, bukan organisasi |

`Gerhana Segara` dan `Sembilan Kerayangan` adalah dua nama yang selamat dari versi lama — tapi arti `Sembilan Kerayangan` berubah.
